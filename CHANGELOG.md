...
- A guided `/morning-triage:setup` skill: installs deps, collects config conversationally, opens the Microsoft 365 + Zoom sign-ins one at a time, and self-checks — no manual `.env` editing or shell steps.
